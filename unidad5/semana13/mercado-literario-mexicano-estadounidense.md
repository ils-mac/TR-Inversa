...
- **Estadísticas de la Industria**: La [Cámara Nacional de la Industria Editorial Mexicana (CANIEM)](https://caniem.org/wp-content/uploads/2023/12/Booklet_ISEP-2023_azul.pdf) presenta anualmente un estudio estadístico de producción y comercio del libro en México, que incluye datos de empresas del sector privado dedicadas a la edición y producción en el país.
...
- [**Cultura de la traducción literaria en México (TRALITMEX)**](https://www.elem.mx/obra/datos/230925) - Este proyecto de El Colegio de México representa una iniciativa fundamental para historizar y visibilizar la traducción literaria en el país.
- [**Enciclopedia de la Literatura en México (ELEM)**](https://www.elem.mx) - La ELEM ha organizado el conocimiento sobre la cultura literaria de México desde 2011, con registros de 13,040 personas (autores, traductores, investigadores literarios) y más de 40,000 obras impresas, incluyendo un enfoque prioritario en el registro de obras traducidas a otros espacios lingüísticos.
