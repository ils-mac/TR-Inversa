---
layout: default
title: Flujo de trabajo colaborativo en Lilt
parent: Semana 8
...
En tu [primera exploración de Lilt](../../unidad2/semana6/lilt-trad-ui.md), muchas personas se centraron naturalmente en las características más visibles: cómo la IAG genera traducciones automáticamente, cómo el sistema aprende de las correcciones, y las impresiones generales sobre la interfaz. Esta es una respuesta completamente apropiada al primer encuentro con una nueva herramienta.
...
Revisa esta página de la Base de Conocimientos de Lilt para continuar desarrollando tus competencias técnicas: [Introduction To LILT Translate](https://support.lilt.com/kb/introduction-to-lilt-translate)
...
1. **Título claro**: "Cómo [hacer X específico] en Lilt"

2. **Contexto**: Una o dos frases explicando por qué esta funcionalidad es útil en el flujo de trabajo profesional

3. **Pasos específicos**: Instrucciones claras paso a paso
...
4. **Captura de pantalla** (opcional pero recomendada): Si puedes, incluye una imagen que muestre la funcionalidad

5. **Consejo profesional**: Una frase final con un tip adicional o una advertencia sobre esa funcionalidad
