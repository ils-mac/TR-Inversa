...
| ------------------ | ----------- |
| Un-Verified Translation (UVT) | - Una traducción que fue generada por IAG o TAN (traducción automática neuronal) sobre la cual no se han realizado verificaciones profesionales, es decir, TA (traducción automática) "en bruto" o "sin editar"<br>- Una traducción hecha por una persona que no está profesionalmente calificada para realizar traducción, como un niño, niña o adulto bilingüe |
