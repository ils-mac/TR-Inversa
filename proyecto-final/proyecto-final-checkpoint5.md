...
**Nota sobre la entrega:** No es necesario crear una carpeta comprimida para este checkpoint. Una vez que completes tu traducción y observaciones, procede directamente a las [Instrucciones de Entrega Final](proyecto-final-entrega.md) para aprender cómo empaquetar todos los componentes de tu proyecto.
...
**¿Listas y listos para la entrega final?** Revisa las [Instrucciones de Entrega Final](proyecto-final-entrega.md) para compilar todos los componentes de tu proyecto.
