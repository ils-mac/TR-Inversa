...
4. **[Checkpoint 4: Glosario](proyecto-final-checkpoint4.md)**
...
- **Nomenclatura**: `[PrimerApellidos]_ProyectoFinal_Checkpoint[#].zip`
- **Ejemplos**:
  - Proyecto individual: `González_ProyectoFinal_Checkpoint1.zip`
  - Proyecto grupal: `González_ReyesMartinéz_ProyectoFinal_Checkpoint3.zip`
